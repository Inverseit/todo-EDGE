...
def start_message(message):
    ...
    bot.send_message(message.chat.id, "`\add` To add tasks to your list <br> `\show` To see all your tasks  <br> `\help` To understand how to use this bot", parse_mode='HTML') # add some text
